...
namespace SDMobileXF.Views
{
    ...
    public partial class VisualizarOcorrenciasCsnPage : ContentPage
    {
        protected ViewModelVisualizarOcorrenciasCsn ViewModel => this.BindingContext as ViewModelVisualizarOcorrenciasCsn;

        public VisualizarOcorrenciasCsnPage()
        {
            Xamarin.Forms.Application.Current.On<Windows>().SetImageDirectory("Assets");
            InitializeComponent();            
            this.BindingContext = new ViewModelVisualizarOcorrenciasCsn(RetornoPesquisar);
        }
        ...
        private void ListView_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            if (e.SelectedItem != null)
            {
                ...
                this.Navigation.PushAsync(new OcorrenciasCsnPage((e.SelectedItem as SDMobileXFDados.Modelos.OcorrenciaCsn).ID_OCORRENCIA, OrigemDados.Api));
